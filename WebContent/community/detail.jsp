...
<body>
	...
	<div style="text-align: center;margin-bottom: 10px;">
		<a class="button" href="update.do?idx=${bean.idx}&page=${pageNo}">수정</a>
		<a class="button" onclick="deleteSet()">삭제</a>
		<a class="button" href="list.do?page=${pageNo }">목록</a>
	</div>
	<!-- 메인글 출력 끝 -->
	<!-- 댓글 시작 -->
	<form action="comment.do?page=${pageNo }" method="post" name="frmCmt">
		...
		<ul id="main">
			...
			<li>
				<ul>
					...
					<li><a href="javascript:deleteCmt('${cmt.idx }','${bean.idx }','${pageNo }')">삭제</a></li>
				</ul>
			</li>
			<li>
				<pre>${cmt.content }</pre>
	...
	<div id="myModal" class="modal">
		...
		<div class="modal-content">
			...
			<div style="padding: 0px 20px;">
				<b>글비밀번호</b><br>
				<br>
				<form action="delete.do?page=${pageNo }" method="post" name="frmPassword"
